            ...
            data = [
                {
                    ...
                    "temperature": 0,
                    "max_tokens": 20,
                    "messages": [{"role": "user", "content": "Lila, a 17-year-old high school student who loves exploring ancient legends, spent her summer vacation at her grandmother's old house in a quiet rural town. One afternoon, while she was weeding the overgrown backyard, she accidentally dug up a rusty iron key buried under the roots of an old oak tree that had stood there for at least a hundred years. The key was about the length of her index finger, with a strange spiral symbol carved on its handle—a pattern she had never seen in any history books or legend collections she had read. When she showed the key to her grandmother, the old woman's eyes widened with surprise and a hint of unease. She told Lila that the backyard of the house used to be part of an ancient manor called Blackwood Manor, which vanished overnight without a trace a century ago. All the residents of the manor disappeared along with it, and no one knew where they went. Some villagers said the manor was swallowed by the earth due to a curse, while others claimed it was taken away by supernatural beings. Grandmother also mentioned that her own grandmother had told her that the manor had a hidden basement, and only a special key could open its door. Now that Lila had found the key, she couldn't suppress her curiosity. She decided to find the hidden entrance to the basement and uncover the mystery of Blackwood Manor's disappearance. Please continue this story with rich details, including Lila's exploration process, the clues she finds, the dangers she encounters, and the final truth about the manor's disappearance. The word count should be no less than 1200 words."}],
                    "stream": True
                },
                {
                    "model": "deepseek",
                    "temperature": 0,
                    "max_tokens": 20,
                    "messages": [{"role": "user", "content": "The spaceship Aurora, a long-distance exploration vessel belonging to the Earth Interstellar Exploration Agency, had been on a mission to search for habitable planets outside the solar system for three years. During this period, the entire crew of 12 people entered hibernation to save resources. However, one day, the ship's emergency alarm system was suddenly triggered, waking all the crew from their deep sleep. When Captain Elena Rodriguez and her teammates regained consciousness and walked into the control room, they were shocked to find that half of the ship's systems had failed. The navigation system was malfunctioning, making it impossible to determine their exact position; the life support system was operating at only 60% capacity, and the energy reserve was rapidly decreasing. Through the dim viewport, they saw a desolate uncharted planet floating in the dark space, with a faint blue light flickering on its surface from time to time. The light seemed to be emitted from a specific area on the planet, and it was rhythmic, as if it were a signal. The crew fell into a dilemma: if they stayed on the damaged spaceship, they would eventually run out of energy and die; if they landed on the unknown planet to look for energy sources or help, they would face unpredictable dangers, as they knew nothing about the planet's environment, whether there was oxygen, and whether there were dangerous creatures or natural disasters. Captain Elena, who had rich interstellar exploration experience, decided to lead a small team to land on the planet to explore. Please continue this science fiction story, describing the crew's preparation for landing, the strange environment they encounter on the planet, the mysterious blue light source they find, the alien civilization or supernatural phenomena they may come into contact with, and how they try to repair the spaceship and return to Earth. The word count should be no less than 1200 words."}],
                    "stream": True
                },
                {
                    "model": "deepseek",
                    "temperature": 0,
                    "max_tokens": 20,
                    "messages": [{"role": "user", "content": "Willowbrook is a small town surrounded by dense forests, where the pace of life is slow and everyone knows each other. For generations, the town has had a strange rule: no one is allowed to walk past the abandoned bakery on Main Street after midnight. The bakery has been closed for 50 years, its windows covered with thick dust, and the signboard at the door is rotten and broken. Rumors about the bakery have been circulating in the town for a long time. It is said that the owner of the bakery, a woman named Martha, was an excellent baker who could make bread that could grant people's wishes. But the bread came at a terrible cost—each wish granted would take away the most precious thing from the wisher. Some people said that a young man once wished for wealth, and after eating Martha's bread, he became rich overnight, but he lost his eyesight the next day; a mother wished for her sick child to recover, and the child got better, but she herself aged 20 years in an instant. Fifty years ago, Martha suddenly disappeared, and the bakery was closed ever since. But many townspeople claim to have seen a figure in white wandering in front of the bakery at midnight, and some have even heard the sound of a rolling pin hitting the counter from inside the bakery. One night, a curious 18-year-old boy named Jake, who had just moved to the town with his family, decided to break the rule and explore the abandoned bakery. He wanted to find out if the rumors were true. Please create a full story based on this setting, describing Jake's exploration of the bakery, the strange things he encounters inside, the truth about Martha and her wish-granting bread, and the choice Jake has to make when he faces the opportunity to make a wish. The word count should be no less than 1200 words."}],
                    "stream": True
                },
                {
                    "model": "deepseek",
                    "temperature": 0,
                    "max_tokens": 20,
                    "messages": [{"role": "user", "content": "Ethan is a 30-year-old librarian who works in a hidden library that only appears to those who are truly lost—whether lost in life, emotion, or faith. The library is located in an alley that no map can mark. Its exterior is inconspicuous, but inside it is spacious and bright, with countless bookshelves stretching to the ceiling, filled with books of all kinds. Ethan has worked here for five years, and he has seen many people come to the library to find comfort or answers. One rainy afternoon, a girl with silver hair walked into the library. She was wearing a tattered coat, her eyes were red and swollen from crying, and she looked extremely haggard. She walked up to Ethan and asked in a trembling voice if there was a book that could erase painful memories. Ethan was stunned, because he knew that such a book really existed in the library—it was hidden in the deepest part of the forbidden area on the third floor. The book was bound in black leather, with no title or author's name. But Ethan also knew the price of this book: erasing painful memories would also take away the related happy memories, and the wisher would lose a part of their own identity. Ethan hesitated whether to tell the girl about the book. He tried to comfort her and asked about her story. The girl, named Luna, told him that she had lost her parents in a car accident a month ago, and the pain of losing them was so great that she couldn't bear it. She just wanted to forget all the memories related to her parents so that she could live normally again. After hearing Luna's story, Ethan was even more tangled. He had to decide whether to help Luna find the book that could erase memories, or try to make her face her pain and get out of the shadow. Please continue this story, describing the conversation between Ethan and Luna, Ethan's inner struggle, the process of them going to the forbidden area to find the book, and the final choice Luna makes. The word count should be no less than 1200 words."}],
                    "stream": True
                },
                {
                    "model": "deepseek",
                    "temperature": 0,
                    "max_tokens": 20,
                    "messages": [{"role": "user", "content": "Dr. Carter is a 45-year-old scientist who has been studying animal behavior for many years. He has always believed that animals have their own language and intelligence, but humans have not found a way to communicate with them. After 10 years of hard work, Dr. Carter finally invented a machine called the 'Animal Language Translator'. This machine can convert the sounds and movements of animals into human language, allowing humans to understand what animals are saying. The first animal Dr. Carter wants to test the machine on is his pet cat, Mimi. Mimi is a black-and-white cat that Dr. Carter has raised for 5 years. He turns on the machine and puts a small sensor on Mimi's collar. Then he says to Mimi: 'Mimi, can you hear me? Can you talk to me?' To Dr. Carter's surprise, the machine immediately outputs a clear voice: 'Yes, I can hear you. I've been wanting to talk to you for a long time.' Dr. Carter is very excited. He starts chatting with Mimi. During the chat, Mimi tells Dr. Carter a shocking secret that will change the world: animals have been watching humans for centuries, and they have their own society and culture. They have long been aware of human activities that damage the environment and destroy nature, but they have been waiting for the right time to reveal their intelligence to humans. Mimi says that the animal world has decided to contact humans through Dr. Carter, hoping to work with humans to protect the earth. Dr. Carter can't believe his ears. He has been pursuing this moment for a long time, but when the truth comes, he is at a loss. He doesn't know if the world is ready to accept the fact that animals have intelligence, and he doesn't know how to convey this message to the public. Please continue this story, describing Dr. Carter's inner shock and hesitation, the process of him verifying Mimi's words through communicating with other animals, the difficulties he faces when he tries to announce the truth to the world, the reaction of the government, the media and the public, and the cooperation between humans and animals to protect the earth. The word count should be no less than 1200 words."}],
                    "stream": True
                },
                {
                    "model": "deepseek",
                ...
                },
                {
                    ...
                    "temperature": 0,
                    "max_tokens": 20,
                    "messages": [{"role": "user", "content": "Ms. Grey is a 38-year-old detective who is known for her sharp mind and careful observation. She has solved many difficult cases. Recently, she was assigned to investigate a series of strange thefts in the city. The strange thing about these thefts is that the thieves did not steal valuable things like money, jewelry, or antiques. The only thing they stole from each victim's house was a single teacup. The teacups stolen were of different styles and prices—some were ordinary daily-use teacups, some were expensive porcelain teacups. The victims had nothing in common, and they didn't know each other. Ms. Grey checked the surveillance cameras at the crime scenes, but the thieves were very clever and avoided all the cameras. She also interviewed the victims, but she didn't get any useful clues. Just when the investigation was at a standstill, Ms. Grey found a clue in the latest theft case: a small piece of blue cloth was left at the scene. Through the analysis of the cloth, Ms. Grey found that it came from an old cottage on the edge of the city. The cottage was inhabited by an old woman named Mrs. Bennett. Ms. Grey went to the cottage to investigate. Mrs. Bennett was a kind-looking old woman with white hair. When Ms. Grey asked her about the thefts, Mrs. Bennett admitted that she was the one who stole the teacups. She said that she was a collector of 'memories stored in teacups'. Every teacup carries the memories of its owner—happy memories, sad memories, warm memories. She steals the teacups because she wants to collect these memories. Ms. Grey was very confused. She didn't believe that teacups could store memories. Please continue this mystery story, describing Ms. Grey's investigation of Mrs. Bennett, the process of Mrs. Bennett proving that teacups can store memories, the reason why Mrs. Bennett collects memory teacups (a sad past related to her family), and the choice Ms. Grey has to make between arresting Mrs. Bennett and understanding her behavior. The word count should be no less than 1200 words."}],
                    "stream": True
                },
                {
                    "model": "deepseek",
                    "temperature": 0,
                    "max_tokens": 20,
                    "messages": [{"role": "user", "content": "A group of four friends—Jake, Lily, Tom, and Emma—are all 19-year-old college students. During the summer vacation, they decide to go camping in the Whispering Forest, a famous forest on the outskirts of the city. The Whispering Forest is beautiful, with tall trees, clear streams, and colorful wild flowers. But it is also full of legends. The most famous legend is about the 'Whispering Woodsman', a mysterious creature that lives in the depths of the forest. It is said that the Whispering Woodsman can grant any wish to people, but in return, he will take something precious from the wisher. The four friends have heard this legend, but they don't believe it. They think it's just a story made up to scare people. On the first night of camping, they sit around the campfire, chatting and laughing. When talking about the legend of the Whispering Woodsman, Jake, who is greedy for money, jokes that he wants to wish for wealth. He says that he doesn't care about the so-called 'precious things' that the Woodsman will take. The other three friends laugh at him, thinking that he is daydreaming. But the next morning, Jake wakes up to find a large bag of gold coins next to his tent. He is very excited, thinking that it's a prank by his friends. But when he looks for his beloved dog, Max, who has been following him all the time, he finds that Max is gone. Jake is very anxious. He asks his friends if they have seen Max, but none of them have. At this moment, he remembers the legend of the Whispering Woodsman. He realizes that the gold coins are the wish granted by the Woodsman, and Max is the precious thing that the Woodsman has taken. Jake is very regretful. He cries and says that he doesn't want the gold coins anymore, he just wants Max back. Please continue this story, describing the friends' reaction to Jake's experience, their decision to help Jake find Max and the Whispering Woodsman, the dangers they encounter in the depths of the forest, the encounter with the Whispering Woodsman, the test that the Woodsman gives them, and whether Jake can get Max back. The word count should be no less than 1200 words."}],
                    "stream": True
                },
                {
                    "model": "deepseek",
                    "temperature": 0,
                    "max_tokens": 20,
                    "messages": [{"role": "user", "content": "Ms. Evans is a 32-year-old primary school teacher. She is kind and patient, and she cares about every student. Ben is one of her students, a 9-year-old boy who is very quiet. He never talks to his classmates, and he always sits in the corner of the classroom. Ms. Evans notices that Ben is very lonely, and she tries to talk to him many times, but Ben always only answers with a few words. One day, during an art class, Ms. Evans asks the students to draw a picture of 'the place where you feel the most at home'. The other students draw their own houses, parks, or grandparents' homes. But Ben draws the same picture as he always does: a small house with a red door, a garden full of sunflowers in front of the house, and a woman with long hair standing in the doorway. Ms. Evans is very curious. She walks up to Ben and asks him: 'Ben, is this your home?' Ben shakes his head and says: 'No, I've never seen this house, but I feel like I belong there.' Ms. Evans is even more confused. She asks Ben if he knows the woman in the picture. Ben says: 'I don't know her name, but I feel that she is very kind to me.' After class, Ms. Evans calls Ben's parents. Ben's parents tell her that Ben was adopted by them when he was 1 year old. They don't know anything about Ben's biological parents or his past. Ms. Evans decides to help Ben find the truth about the house and the woman in his picture. She believes that this picture is related to Ben's biological family. Please create a story based on this setting, describing Ms. Evans' investigation process, the clues she finds (such as the location of the house with the red door), the difficulties she faces, the encounter between Ben and his biological family, and the changes that happen to Ben after finding his roots. The word count should be no less than 1200 words."}],
                    "stream": True
                },
                {
                    "model": "deepseek",
                    "temperature": 0,
                    "max_tokens": 20,
                    "messages": [{"role": "user", "content": "In a world where everyone is assigned a job at birth by the government, people's lives are arranged from the moment they are born. They don't have the right to choose their own careers. Elara is a 16-year-old girl who was assigned to be a 'Memory Keeper' at birth. The job of a Memory Keeper is to store the memories of people who have passed away. When a person dies, their memories are extracted by a special machine and stored in a crystal. The Memory Keepers are responsible for taking care of these crystals and ensuring that the memories are not lost. Elara has been trained as a Memory Keeper since she was a child. She is very good at her job, but she has always felt empty. She doesn't know who her parents are. Her supervisor told her that her parents died in an accident when she was a baby, and their memories were not preserved. One day, when Elara is sorting out the memory crystals, she finds a crystal that is different from the others. The crystal is glowing with a faint purple light, and there is no label on it. Elara is curious. She puts the crystal into the memory viewer, a machine that can play the memories stored in the crystal. To her surprise, the memories in the crystal belong to her mother. In the memories, Elara sees her mother, a beautiful woman with long hair. Her mother tells the story of her and Elara's father: they were rebels who opposed the government's rule of assigning jobs at birth. They wanted to give people the right to choose their own lives. But their rebellion was discovered by the government, and they were forced to go into hiding. Before Elara was born, her mother hid her in an orphanage to protect her. The memory ends with her mother's last wish: she hopes that Elara can live a free life and not be constrained by the government's arrangement. Elara is shocked and sad. She finally knows her identity, and she also knows the secret of her parents. Please continue this story, describing Elara's inner struggle between abiding by the government's rules and fulfilling her parents' wishes, the process of her looking for the truth about her parents' fate, the friends she meets who also oppose the government's rule, the dangers she faces, and her efforts to fight for freedom and the right to choose. The word count should be no less than 1200 words."}],
                    "stream": True
                },
                {
                    "model": "deepseek",
                    "temperature": 0,
                    "max_tokens": 20,
                    "messages": [{"role": "user", "content": "Captain Morgan is a 50-year-old sailor who has sailed the seven seas for 20 years. He has experienced countless storms and dangers, and he has many stories about the sea. Now, he is planning to retire after his last voyage. His last voyage is to transport a batch of goods from Europe to America. The journey is smooth at first, but when the ship is passing through a remote sea area, they encounter a sudden storm. The wind is howling, the waves are towering, and the ship is shaking violently. Just when Captain Morgan thinks that all is lost, he sees a mermaid with long golden hair and a blue tail appearing on the surface of the sea. The mermaid swims to the side of the ship and says to Captain Morgan in a clear voice: 'I can help you get out of the storm, and I can also give you a map to a treasure that can make you immortal. But the map has a warning: the treasure is guarded by the sea itself, and it will test your soul. If you fail the test, you will lose everything, including your life.' Captain Morgan is shocked. He has heard stories about mermaids and sea treasures, but he has never believed them. Now, facing the choice between life and death, and the temptation of immortality, Captain Morgan is very tangled. He knows that immortality is something that many people dream of, but he also knows that there must be a huge risk behind it. After thinking for a long time, Captain Morgan decides to accept the mermaid's offer. He wants to see what the treasure that can make people immortal looks like, and he also wants to challenge the test of the sea. Please continue this adventure story, describing how the mermaid helps the ship get out of the storm, the content of the treasure map, the journey of Captain Morgan and his crew to find the treasure, the tests that the sea gives them (such as facing their own desires, making difficult choices), the truth about the immortal treasure, and Captain Morgan's final choice. The word count should be no less than 1200 words."}],
                    "stream": True
                },
                
                {
                    ...
                    "temperature": 0, 
                    "max_tokens": 20, 
                    "messages": [{"role": "user", "content": "Bramblehold Village is surrounded by dense brambles, and the villagers can control brambles and use them for defense—some can make brambles grow quickly to form fences, others can use them to trap wild beasts, and a few can even make bramble thorns release a mild anesthetic. Sophia, a 10-year-old girl in the village, cannot control any brambles. No matter how she touches them, the brambles remain unchanged, and sometimes they even prick her. The other children tease her, calling her 'the Bramble-Hated' and not letting her play near the bramble fences. Sophia often sits outside the bramble fences, watching the others control brambles and feeling sad. One morning, a small hedgehog with spines covered in leaves crawls to her feet. The hedgehog is the guardian of the brambles, and it tells Sophia that her power is not controlling brambles, but communicating with the small mammals in the brambles—hedgehogs, rabbits, squirrels, and even the tiny shrews. Sophia is skeptical at first. The hedgehog asks her to stay quiet and listen. When she does, she suddenly hears a chorus of small voices—the rabbits are telling her that a fox has entered the brambles and is preying on them, and the squirrels are warning that the brambles are being eaten by a kind of caterpillar that will soon destroy the village's defense. Sophia is overjoyed. She has finally found her own special power. Please continue this story, describing Sophia's process of learning to use her power to communicate with small mammals, the help she provides to the villagers (such as driving away the fox, eliminating the caterpillars), the changes in the villagers' attitude towards her, the danger the village faces (such as a pack of wolves attacking the village after the brambles are destroyed), and how Sophia uses her power to gather the small mammals to help defend the village. The word count should be no less than 1200 words."}], 
                    "stream": True
                },
                {
                    "model": "deepseek", 
                    "temperature": 0, 
                    "max_tokens": 20, 
                    "messages": [{"role": "user", "content": "Volcanovale Village is located at the foot of an active volcano, and the villagers can control the heat from the volcano—some use it to cook food, others use it to warm their houses in winter, and a few can even detect changes in the volcano's activity. Owen, a 12-year-old boy in the village, cannot feel any heat from the volcano. No matter how close he gets to the volcano's crater, he only feels cold. The other children mock him, calling him 'the Volcano Cold Boy' and excluding him from activities related to the volcano. Owen often sits on a rock far from the volcano, watching the smoke rise from the crater and feeling lonely. One day, a lizard with red scales crawls onto his hand. The lizard is the guardian of the volcano, and it tells Owen that his power is not controlling volcanic heat, but communicating with the volcano's spirits and predicting volcanic eruptions accurately. It says that his cold feeling is a protection from the volcano's extreme heat, allowing him to get closer to the volcano's core to listen to its warnings. Owen doesn't believe it at first. The lizard asks him to approach the volcano's crater slowly. When he does, he suddenly hears a deep rumbling voice—the volcano's spirit is telling him that a small eruption will happen soon, and a larger one is coming in a few weeks. Owen's eyes widen with excitement. He has found his own power. Please continue this story, describing Owen's learning to use his power to communicate with the volcano's spirit, the help he gives to the villagers (such as evacuating them before the small eruption, preparing for the large eruption), the changes in the villagers' attitude towards him, the danger the village faces (such as the large volcanic eruption triggering lava flows and ash clouds that threaten to bury the village), and how Owen uses his power to guide the villagers to a safe place. The word count should be no less than 1200 words."}], 
                    "stream": True
                },
                {
                    "model": "deepseek", 

...
from utils import (
    append_new_token, append_new_token_seq,
    append_new_token_seq_group, create_dummy_prompt,
    get_sequence_groups, schedule_and_update_computed_tokens
)

def test_sequence_scheduler_add_group():
    block_size = 128

    cache_cfg = CacheConfig(block_size, 1.0, 1, cache_dtype="auto")
    cache_cfg.num_cpu_blocks = 128
    cache_cfg.num_gpu_blocks = 128
    ...
    scheduler = Scheduler(scheduler_cfg, cache_cfg, None)
...
def test_sequence_scheduler_abort_group():
    block_size = 128
    ...
    scheduler = Scheduler(scheduler_cfg, cache_config, None)

...
class Test_e2e_models():
    ...
    def _model_runner(self, local_rank: int, world_size: int, model_info, enable_graph, enable_quant):
        ...
        if enable_graph and enable_quant:
    ...
    def test_model(self, world_size: int, model_arch: str, enable_graph: bool, enable_quant: bool):
        ...
        try:
            mp.spawn(
                self._model_runner,
                args=(world_size, model_info, enable_graph, enable_quant),
                nprocs=world_size,
            )
        finally:
